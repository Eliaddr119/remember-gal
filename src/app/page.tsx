    ...
    <div className="min-h-screen bg-warm-gradient relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Quick Links */}
          <nav aria-label="קישורים מהירים" className="mt-10 max-w-3xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {[
                ...
                { href: "/events", label: "אירועים", description: "צפו באירועים וטקסים לזכותה של גל", icon: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" },
                ...
                { href: "/education", label: "הדרכה", description: "חומרי הדרכה וחינוך לזכותה של גל", icon: "M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" },
                { href: "/posts", label: "הפוסטים של גל", description: "פוסטים ששיתפה גל", icon: "M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" },
              ].map((link, i) => (
                <Link
                  key={link.href}
                  href={link.href}
                  aria-label={`${link.label} - ${link.description}`}
                  className={`group flex flex-col items-center gap-2 p-3 rounded-xl bg-ivory-50/90 hover:bg-sunflower-100 border border-earth-200 hover:border-sunflower-300 transition-all duration-300 shadow-warm hover:shadow-warm-lg ${i === 4 ? "col-start-1 col-end-3 mx-auto w-1/2 md:w-auto md:col-auto" : ""}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                  ...
                  <span className="text-sm md:text-base text-earth-700 group-hover:text-earth-800 font-medium whitespace-nowrap">
                    {link.label}
                  </span>
                </Link>
              ))}
